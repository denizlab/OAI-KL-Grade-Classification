...
fname = './bounding_box_oulu/no_knee.txt'
...
train_with_neg.to_csv('train_with_neg.csv', index=False)
test_with_neg.to_csv('test_with_neg.csv', index=False)
val_with_neg.to_csv('val_with_neg.csv', index=False)
